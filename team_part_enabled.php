            ...
            <div class="modal-body">
               <div class="container-sec">
                  <form id="form_data_team_paid" method="post">
                     ...
                     <div class="row input-center">
                        <div class="col-75">
                           <input type="text" placeholder="Password" name="password" id="password_team_paid" class="form-control">
                     ...
                     <div class="row">
                        ...
                        <input type="button" id="submit_business_paid"  class="btn btn-primary btn-block button-form businesspaidpremium" style="padding: 6px 12px;" value="Save"></button>
                        <div id="overlay3">
            ...
            <div class="modal-body">
               <div class="container-sec">
                  <form id="form_data_contact" method="post" >
                     ...
                     <div class="row input-center">
                        <div class="col-75"> 
                           <textarea placeholder="Message" name="Message" id="Message_contact" cols="30" rows="10"></textarea>
                        </div>
                     </div>
                     <div class="row">
                        <label style="display: block">&nbsp; &nbsp;</label>
                        <input type="button" name=""  value="Save" id="submit_email"  class="btn btn-primary btn-block button-form submitemailbtn" style="padding: 6px 12px;"/>
                        <div id="overlay4">
                     ...
                     <div class="row">
                        ...
                        <div id="success_team_contact" class="text-success" style="padding:15px;"></div>
                     </div>
                  </form>
               </div>
            </div>
         ...
         <div class="pricing__price">
            ...
            <div class="pricing__cta">
               <div class="w-embed w-script"> 
                  <button  id="getstart4" data-tf-popup="eQGqkof8" data-tf-size="70" data-tf-auto-close="100000" data-tf-hidden="utm_source=website,utm_medium=organic,utm_campaign=teams,utm_content=survey" class="button is--pricing w-inline-block " data-tf-loaded="true"  data-toggle="modal" data-target="#contact-popup3">Get started</button>
               </div>
            </div>
         </div>
         <div class="pricing__features">
